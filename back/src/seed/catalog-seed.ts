/** Type des icônes — dans le backend, une simple chaîne (les icônes sont résolues côté client). */
export type IconName = string;

/**
 * Données seed pour le catalogue de formations.
 * Extrait de catalog.ts pour réduire la taille du fichier.
 */
